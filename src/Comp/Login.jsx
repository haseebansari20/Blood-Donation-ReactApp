...
function Login1(props) {  
    ...
    const apiUrl = "https://localhost:7154/api/User/Login";    
    const Login = (e) => {    
            e.preventDefault();    
            debugger;   
                  ...
                  <div class="col-lg-6">  
                    <div class="p-5">  
                      ...
                      <form onSubmit={Login} class="user">  
                        ...
                        <div class="form-group">  
                          <input type="password" class="form-control" value={user.pass} onChange={ onChange }  name="Password" id="DepPasswordartment" placeholder="Password"/>  
                        </div>  
                        {/* <div class="form-group">  
